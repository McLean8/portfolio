  ...
  return (
    <section id='contact' ref={sectionRef} className='min-h-screen flex flex-col justify-center py-40 bg-darker relative overflow-hidden'>
            ...
            <form onSubmit={handleSubmit} className='space-y-16'>
              {formSubmitted ? (
                ...
                <div className='space-y-12'>
                  <div>
                    <label htmlFor='name' className='text-xl text-light flex mb-4' style={{ border: 'none' }}>
                  ...
                  <div>
                    <label htmlFor='email' className='text-xl text-light flex mb-4' style={{ border: 'none' }}>
                  ...
                  <div>
                    <label htmlFor='message' className='text-xl text-light flex mb-4' style={{ border: 'none' }}>
      ...
      <div className='flex justify-center mt-32 gap-8'>
        ...
        <a href='mailto:oethan.mclean@icloud.com' aria-label='Email' className='text-gray-400 hover:text-neon-purple transition-colors duration-300'>
          <svg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='0 0 24 24' fill='currentColor'>
            <path d='M12 12.713l-11.985-9.713h23.97l-11.985 9.713zm0 2.574l-12-9.725v15.438h24v-15.438l-12 9.725z' />
          </svg>
        </a>

        <a href='https://www.linkedin.com/in/ethan-otermin-mclean-5b50021a5/' target='_blank' rel='noopener noreferrer' aria-label='LinkedIn' className='text-gray-400 hover:text-neon-purple transition-colors duration-300'>
          <svg xmlns='http://www.w3.org/2000/svg' width='48' height='48' viewBox='0 0 24 24' fill='currentColor'>
